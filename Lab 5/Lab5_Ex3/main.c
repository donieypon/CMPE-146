...
void calibrate() {
    ...
    thresholdFreq = (uint32_t)(counterValue / 0.002) - 5000;
}
...
int main(void)
{
    ...
    /* Calibration: read and calculate oscillator frequency before loop and set threshold */
    calibrate();
    ...
    while (1) {
        ...
        if (oscillatorFreq < thresholdFreq) {
